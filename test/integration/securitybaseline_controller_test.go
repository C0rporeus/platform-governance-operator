...
var _ = Describe("SecurityBaseline Controller", func() {
	Context("When reconciling a resource", func() {
		const resourceName = "test-securitybaseline"
		...
		It("should successfully reconcile the resource", func() {
			...
			controllerReconciler := &controller.SecurityBaselineReconciler{
				Client:   k8sClient,
			...
			reconciledAfterSecondRun := &corev1alpha1.SecurityBaseline{}
